...
select is((select relrowsecurity from pg_class where oid = 'private.reference_import_runs'::regclass), true, 'private import ledger enforces RLS as defense in depth');
