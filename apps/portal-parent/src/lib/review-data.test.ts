...
describe("review data adapter", () => {
  ...
  it("uses the live declaration contract and canonical product university id", () => {
    ...
    expect(submission.reviewData).toMatchObject({
      ...
      declarations: {
        version: "inpolor-launch-2026-08-16",
        adult: true,
        rights: true,
        terms: true,
        privacy: true,
    ...
    expect(submission.reviewData).not.toMatchObject({
      declarations: { version: "inpolor-review-v1" },
    });
  });
