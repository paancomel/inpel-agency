...
export function createReviewSubmission(draft: ReviewDraft) {
  ...
  const declarations = {
    ...
    age18OrOlder: draft.declarations.age,
    termsAccepted: draft.declarations.terms,
    privacyAcknowledged: draft.declarations.privacy,
    contentRightsConfirmed: draft.declarations.rights,
  };
  const reviewData = {
